...
var YoutubeDialog = {
    ...
    insert: function () {
        ...
        tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<iframe width="540" height="400" src="http://www.youtube.com/embed/'+ code +'" frameborder="0" allowfullscreen></iframe>');
        tinyMCEPopup.close();
    }
};
